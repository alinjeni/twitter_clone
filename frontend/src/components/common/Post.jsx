...
const Post = ({ post }) => {
	...
	const { mutate : likePost , isPending: isLiking } = useMutation({
		...
		onSuccess:( updatedLikes )=>{
			...
			// queryClient.invalidateQueries({
			// 	queryKey: ["posts"]                  
			// })         // entire posts getting refershed while liking the post, so use following approach

			// cache post data and update cache data to refresh the only posy while liking
